...
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * Important:
         * To make the mutable OPE stable and simple, we insert values in sorted order
         * during bootstrap. This guarantees correct ordering and avoids depending on
         * random CSV insertion order.
         */
...
// public class Bootstrap {
// public static final Path DEFAULT_DATASET =
// Path.of("Dataset-Emp-Database.csv");
// public static final Path DEFAULT_KEYS =
// Path.of("client_keys/client.properties");
...
// System.out.println("Bootstrap finished.");
// System.out.println("Plain records read: " + plainEmployees.size());
// System.out.println("Encrypted records uploaded to MySQL: " +
// encrypted.size());
// System.out.println("Encryption time ms: " + ((encryptEnd - encryptStart) /
// 1_000_000));
// System.out.println("Total bootstrap time ms: " + ((t1 - t0) / 1_000_000));
// System.out.println("Client keys saved/loaded at: " +
// DEFAULT_KEYS.toAbsolutePath());
// }
// }
